@extends('master')
@section('title', ' General Busines Consult Page')
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100 animated fadeIn" src="/img/bookus.jpg" alt="First slide" >
        ...
        <h3 class=" xt-center display-6 animated fadeInDown delay-1s font-sans semibold text-5xl"><strong> General Business Consult</strong></h3>
        <p class=" font-sans font-thin text-p text-white  animated fadeInUp delay-1s pb-3">Provides  <span style="color: #8AC03C;">consultancy services </span> on starting and growing your business  </p>
	    ...
	    <div class="w-full md:w-2/3 px-4">
	 	...
	 	<div class="pb-2 flex">
			<div class="flex-no-shrink">
				<i class="icon-presentation text-2xl mr-4" style="color: #8AC03C;"></i>
			</div>
			
			<div>
				<h6 class=" w-full text-muted pb-2 text-2xl font-sans font-medium " style="color: #8AC03C;">General Business Consult
					<br> <hr style=" border: none; height: 2px; background-color: #8AC03C; width: 10%;" align="left" >
				</h6>

				<p class="font-sans" style="color: #7d7d7d;">We give advice on how to start a business, grow and expand your business to meet modern trends <p>
			    ...
			    <blockquote class=" bg-white shadow pr-4 italic font-sans text-muted flex mb-4 ">
			    	...
			    	<div class="py-4">
			    		The architect of tomorrow's image in life is the choice made today <br> <br>
