@extends('master')
@section('title', ' Industrial and Socio-Politico-Economic Research Page')
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100 animated fadeIn" src="/img/bookus.jpg" alt="First slide" >
        ...
        <h3 class=" xt-center display-6 animated fadeInDown delay-1s font-sans semibold text-5xl"><strong> Industrial and Socio-Politico-Economic Research</strong></h3>
        <p class=" font-sans font-thin text-p text-white  animated fadeInUp delay-1s pb-3">Provides  <span style="color: #8AC03C;"> platform </span> for Industrial and Socio-Politico-Economic Research research  </p>
	    ...
	    <div class="w-full md:w-2/3 px-4">
	 	...
	 	<div class="pb-2 flex">
			<div class="flex-no-shrink">
				<i class="icon-book-open text-2xl mr-4" style="color: #8AC03C;"></i>
			</div>
			
			<div>
				<h6 class=" w-full text-muted pb-2 text-2xl font-sans font-medium " style="color: #8AC03C;">Industrial and Socio-Politico-Economic Research
					<br> <hr style=" border: none; height: 2px; background-color: #8AC03C; width: 10%;" align="left" >
				</h6>

				<p class="font-sans" style="color: #7d7d7d;">Provides platform for Industrial and Socio-Politico-Economic Research research<p>
			    ...
			    <blockquote class=" bg-white shadow pr-4 italic font-sans text-muted flex mb-4 ">
			    	...
			    	<div class="py-4">
			    		To appreciate beliefs on choice in life, query your past, present and future<br> <br>
...
{{-- section b of managmentt --}}
		...
		<div class="w-full md:w-1/3 px-4">
			...
			<div class="mb-4 flex flex-wrap">
				...
				<a class="py-2 text-white text-sm hover:no-underline mb-2 pr-8 pl-2 font-sans w-full" style="background-color: #8AC03C;" href="/industrial">General Business Consult</a>
 ...
 {{-- Make an appointment section --}}
		...
		<br> <hr style=" border: none; height: 2px; background-color: #8AC03C; width: 15%;" align="left" >
		 ...
		 <form action="/journal" method="POST" class="w-full mt-2 shadow-sm px-4 py-4 mb-4" style="background-color: #F8FAFC;">
	          {{ csrf_field() }}
