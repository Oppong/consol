...
<div class="flex items-center justify-center">
	...
	<form action="{{route('users.store')}}" method="POST" class="mt-16 py-8 bg-white px-16 shadow-lg rounded-lg font-sans">
		 {{ csrf_field() }}
            <div class="border-b py-3 text-grey-darker mb-4 font-bold "> Create User </div>
		         <div class="mb-6">
                 ...
                 <div >
                     <button type="submit" class="bg-blue-dark hover:bg-blue px-4 text-white text-sm py-2 rounded-full mr-16">Add User </button>
