...
<head>
    ...
    <title>MCRC booking Email Letter </title>
...
<body style="margin: 0; padding: 0">
    ...
    <h5 style=" color: #F96332;"> phone number </h5>
    <p>{{ $phone }}</p>

     <h5 style=" color: #F96332;"> appointment time </h5>
    <p>{{ $apptime}}</p>

     <h5 style=" color: #F96332;"> appointment date </h5>
    <p>{{ $appdate}}</p>
